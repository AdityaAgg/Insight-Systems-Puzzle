...
## Modifications/Steps
1. [Challenge Attempt Documentation](systems_puzzle_steps.md)
  _May make further modifications, but I wanted to submit now because baseline requirements I think are complete._
